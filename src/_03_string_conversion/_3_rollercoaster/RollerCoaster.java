...
public class RollerCoaster {
	...
	String heightToRide = JOptionPane.showInputDialog("How tall are you(Use Inches)");
		...
		if(heightAsInt>=48) {
			JOptionPane.showMessageDialog(null, "You can go on this ride!");
		}
		...
		// "You can ride the coaster with someone else!" 
			...
			JOptionPane.showMessageDialog(null, "You can ride with an adult!");
		}
		// 6) else print: "You must be at least 42 inches tall to ride the roller coaster pal!"
		else {  System.out.println("You must be at least 42 inches tall");
		} 
